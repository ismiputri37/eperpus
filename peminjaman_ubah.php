                ...
                <form action="" method="POST">
                    ...
                    $id = $_GET['id'];
                        if(isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "UPDATE peminjaman SET id_buku='$id_buku', tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian',status_peminjaman='$status_peminjaman' 
                            ...
                            <div class="col-md-8">
                                <!-- <input type="text" class="form-control" name="kategori"> -->
                                 <select name="id_buku" class="form-control">
                                    ...
                                    ?>
                                    <option <?php if($buku['id_buku'] == $data['id_buku']) echo 'selected' ?> value="<?= $buku['id_buku']; ?>">
                                        <?= $buku['judul']; ?>
                                    </option>
                                    <?php endwhile; ?>    
                                 </select>
